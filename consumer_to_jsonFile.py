...
if __name__ == '__main__':
    ...
    fichier = open("data/customer.json", "a")
    ...
    for message in consumer:
        if message.value != None:
            ...
            rows_to_insert = {"op": op, "ts_ms": ts_ms_int, "ts_local_time": ts_str_tz, "id": id, "first_name": first_name, "last_name": last_name, "email": email}
            
            errors = json.dump(rows_to_insert, fichier)  # Make an API request.
            if errors == None:
